    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-8 lg:border-r border-gray-200 dark:border-gray-800 lg:pr-8">
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="pb-6 border-b border-gray-200 dark:border-gray-800 md:pb-0 md:border-b-0">
            <SkeletonBox className="h-4 w-full mb-2" />
            <SkeletonBox className="h-4 w-2/3" />
          </div>
          <div className="md:border-l border-gray-200 dark:border-gray-800 md:pl-6">
            <SkeletonBox className="h-4 w-full mb-2" />
      ...
      <div className="lg:col-span-4 space-y-5">
        ...
        {/* Newsletter skeleton */}
        <div className="mt-8 pt-4 border-t-2 border-gray-900 dark:border-gray-100">
