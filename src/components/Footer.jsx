      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 text-sm">
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+543425213071" className="hover:text-white transition-colors">342 521 3071</a>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-gray-400">Comercial:</span>
              <a href="tel:+543424662109" className="hover:text-white transition-colors">342 466 2109</a>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61564405341820"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors"
              aria-label="Facebook"
            ...
            <a
              href="mailto:josenizzo@gmail.com"
              className="text-gray-400 hover:text-white transition-colors"
              aria-label="Email"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-6 pt-6 text-center">
          <p className="text-sm text-gray-400">
            Todos los derechos reservados © 2008 josenizzo.info
          </p>
          <p className="text-xs text-gray-500 mt-2">
            Hecho en Argentina por AG MONTENEGRO SRL
          </p>
        </div>
      </div>
    </footer>
