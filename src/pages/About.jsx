            ...
            <section className="bg-gray-50 dark:bg-gray-900 p-8 rounded-lg">
              ...
              <div className="space-y-2">
                <p className="text-gray-700">
                  <strong>Email:</strong> <a href="mailto:josenizzo@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">josenizzo@gmail.com</a>
                </p>
                <p className="text-gray-700">
                  <strong>Newsletter:</strong> Suscribite desde nuestra <a href="/" className="text-blue-600 dark:text-blue-400 hover:underline">página principal</a>
                </p>
              </div>
            </section>
          </div>
